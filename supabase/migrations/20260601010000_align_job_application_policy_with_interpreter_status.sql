-- Align job application insert eligibility with the admin approval flow.
-- Admin approval sets interpreters.status = 'active'; interpreters.approved is the verified badge flag.
