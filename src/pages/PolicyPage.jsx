...
export const POLICY_PAGES = {
  commonTerms: {
    ...
    sections: [
      ...
      {
        iconName: "briefcase",
        title: "제2조 (ON-LI의 역할 및 책임 범위)",
        items: [
          "ON-LI는 기업과 통역 인력을 연결하는 통역 매칭 플랫폼 운영자로서, 통역 의뢰 등록, 통역 지원, 매칭 관리, 일정 조율, 정보 전달 및 정산 지원 서비스를 제공합니다.",
          "통역 업무는 매칭된 통역사가 독립적으로 수행하는 용역이며, ON-LI는 통역사가 제공하는 통역 업무의 직접 제공자가 아닙니다.",
          "통역 업무 수행 과정에서 발생하는 통역 품질, 업무 태도, 현장 대응 및 업무 결과에 관한 사항은 원칙적으로 해당 업무를 수행한 통역사의 책임 범위에 해당합니다.",
          "ON-LI는 원활한 플랫폼 운영을 위하여 기업과 통역사 간 소통 지원, 일정 조율, 정보 전달, 정산 지원 및 문제 발생 시 해결을 위한 중재 지원을 제공할 수 있습니다.",
          "ON-LI의 고의 또는 중대한 과실로 인해 발생한 손해에 대해서는 관련 법령에 따라 책임을 부담합니다."
        ],
      },
      {
        iconName: "user",
      ...
      },
      {
        ...
        items: [
          ...
          "기업이 ON-LI에 지급한 통역 매칭 서비스 이용 대금 중 ON-LI의 플랫폼 이용 수수료 및 정산 관리 비용을 제외한 금액은 통역사에게 정산됩니다.",
      ...
      },
      {
        ...
        items: [
          "① 매칭 확정 후 책임",
          "통역사는 ON-LI 운영팀의 최종 매칭 안내를 받은 시점부터 해당 통역 일정 수행 의무가 발생합니다.",
          "② 취소 기준",
  ...
  interpreterPolicy: {
    ...
    sections: [
      {
        iconName: "info",
        title: "제1조 (통역사의 지위 및 책임)",
        items: [
          "통역사는 ON-LI 플랫폼을 통해 기업과 연결되는 독립적인 통역 활동자로서 업무를 수행합니다.",
          "통역사는 본인이 수락한 일정, 업무 내용 및 현장 활동에 대해 책임을 가지고 수행해야 합니다.",
          "통역사의 지각, 무단 불참, 업무 태도 문제, 업무 수행 과정에서 발생하는 문제는 원칙적으로 해당 통역사의 책임 범위에 해당합니다.",
          "통역사는 기업과 합의된 업무 조건 및 ON-LI 플랫폼 이용 기준을 준수해야 합니다."
        ],
      },
      {
        iconName: "alertTriangle",
        ...
        items: [
          "통역사는 매칭 확정된 일정에 대해 사전 합의된 시간과 장소에 출근하여야 합니다.",
  ...
  clientPolicy: {
    ...
    sections: [
      {
        iconName: "info",
        title: "제1조 (기업 이용자의 이해 및 책임)",
        items: [
          "기업 이용자는 ON-LI가 통역 인력 연결 및 운영 지원을 제공하는 플랫폼임을 이해하고 이용합니다.",
          "기업은 매칭된 통역사와 사전에 안내된 업무 조건, 일정 및 업무 범위를 확인해야 합니다.",
          "업무 범위를 초과하는 요청 또는 사전 협의되지 않은 업무 변경은 통역사와의 협의가 필요할 수 있습니다."
        ],
      },
      {
      ...
      <footer className="policy-footer">
        <div className="policy-footer-container">
          <div className="policy-footer-brand">
            <strong>ON-LI</strong>
            <span>KOREA-JAPAN ONLINK INTERPRETATION PLATFORM</span>
          </div>
          <div className="policy-footer-info">
            <p>한일 비즈니스 매칭의 신뢰로운 파트너 | ONLINK 운영팀</p>
            <p>
              운영 문의 이메일:{" "}
