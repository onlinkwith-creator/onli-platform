      ...
      <main className="home-main" id="about-onli">
        ...
        <section className="home-feature-card">
          ...
          <div className="home-feature-list">
            <Feature
              symbol="01"
              title="필요한 통역사를, 공고 하나로 빠르게."
              text={
                <>
                  조건을 등록하면 일정·분야가 맞는 통역사가 직접 지원합니다.
                  <br />
                  복잡한 검색 없이 필요한 인재를 효율적으로 모집하세요.
                </>
              }
            />
            <Feature
              symbol="02"
              title="통역사 선택, 이제 감이 아닌 검증 기준으로."
              text={
                <>
                  언어 능력뿐만 아니라 실제 현장 경험,
                  <br />
                  전문 분야, 통역 레벨을 기준으로 비교하고 선택하세요.
                </>
              }
            />
            <Feature
              symbol="03"
              title="모집부터 정산까지 하나의 흐름으로."
              text={
                <>
                  공고 등록부터 지원자 관리, 매칭, 정산까지
                  <br />
                  ON-LI에서 간편하게 진행할 수 있습니다.
                </>
              }
            />
          </div>
